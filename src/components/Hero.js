...
const Hero = forwardRef((props, ref) => {
    ...
    return (
        ...
        <div ref={ref} id='hero' className='bg-neutral-900 bg-opacity-95 md:h-screen w-full'>
            <div className="max-w-6xl mx-auto px-4 py-10 md:py-32">
                <div className="flex flex-col md:flex-row items-center  relative gap-16 md:gap-40 text-white">
                    <div className="flex flex-col">
                        ...
                        <h1 className='text-4xl md:text-6xl leading-4 my-8 font-sans font-bold text-[#ffc86b]'>Gourav Garg </h1>
