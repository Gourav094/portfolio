            ...
            <div className="max-w-7xl mx-auto px-10 py-10 md:py-40">
                <div className="flex flex-col md:flex-row items-center md:justify-between relative gap-16 md:gap-0  text-white">
                    <div className="flex flex-col">
                        ...
                        <span className="overflow-hidden w-fit">
                            <h1 className='text-4xl md:text-5xl  my-2  font-sans font-medium text-[#ffc86b]'>Gourav Garg </h1>
                        </span>
                        ...
                        <div className='' data-aos="zoom-in-up">
                            ...
                            <a alt='resume' href={socialLinks.Resume} target='"_blank' rel="noopener noreferrer"><button className='text-[#ffc86b] px-4 py-2 border border-[#ffc86b] rounded-lg font-semibold hover:text-[#111] hover:bg-[#ffc86b] transition-all duration-300 hover:bg-opacity-90 hover:scale-95'>My resume</button></a>
                    </div>
                    <div className="w-full lg:w-1/4 h-60 relative group">
