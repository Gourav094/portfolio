...
const Projects = forwardRef((props, ref) => {
    ...
    return (
        <div ref={ref} id='projects' className='bg-neutral-900 h-fit text-white py-14 '>
            <div className='max-w-7xl mx-auto'>
                <h1 className='py-20'> <span className='text-2xl font-medium'>Projects I have developed</span>
                    <span className='hidden md:inline-flex md:w-60 lg:w-72 h-[.7px] bg-gray-600 mb-2 ml-6'></span>
                </h1>
                <div className='flex flex-col gap-36'>
                    <div className='flex gap-10 pb-22'>
                        <div className='w-1/2 h-full border-1 shadow-lg cursor-pointer'>
                            <img src={chatflix} className='rounded-2xl' alt='project1' />
                        </div>
                        <div className='text-right w-1/2 pt-6'>
                            <h1 className='text-3xl font-medium pb-6'>Chatflix</h1>
                            <p className='bg-slate-400 bg-opacity-10 text-xs md:text-base p-2 md:p-4 rounded-2xl mb-6'>Chatflix is a Streaming platform that offers to watch TV shows and movies on an internet-connected device. Integrate dynamic data through TMDB API. Ensured data security with Authentication and Protected routes.</p>
                    ...
                    <div className='flex gap-10 pb-20'>
                        <div className='text-left w-1/2 pt-12'>
                            <h1 className='text-3xl font-medium pb-6'>HungerHub</h1>
                            <p className='bg-slate-400 bg-opacity-10 text-xs md:text-base p-2 md:p-4 rounded-2xl mb-6'>HungerHub is a food ordering platform built using parcel. Integrated lazy loading for faster response time and optimized initial loading. Ensured stability through comprehensive testing.</p>
                    ...
                    <div className='flex gap-10 pb-22'>
                        ...
                        <div className='text-right w-1/2 pt-6'>
                            ...
                            <p className='bg-slate-400 bg-opacity-10 text-xs md:text-base p-2 md:p-4 rounded-2xl mb-6 '>A Video Streaming Platform, featuring Infinite Scroll, Live Chat with API pooling, and a powerful search bar with Debouncing. Reduced website load time by 300ms through search result caching.</p>
                            <ul className='text-sm font-medium tracking-tight flex max-w-[600px] flex-wrap  gap-1 md:gap-2 justify-end mb-4'>
                                <li className='bg-gray-800 text-[#ffc86b] px-2 rounded-md'>Javascript</li>
                                <li className='bg-gray-800 text-[#ffc86b] px-2 rounded-md'>React</li>
                                <li className='bg-gray-800 text-[#ffc86b] px-2 rounded-md'>TailwindCSS</li>
...
My specialization is centered around Full stack development, creating backend using node and express and the creation of UI / UX, with a specific focus on Javascript, React and solid expertise in databases, API Rest integrations. With good knowledege of Data structures, i've solved 550+ problems on leetcode. My approach translates into the creation of modern and intuitive web platforms , where the fusion of aesthetics and functionality is key to achieving exceptional results.
