...
const About =forwardRef((props, ref)=> {
    ...
    return (
        <div ref={ref} id='about' className='text-white pl-24 pt-24 bg-neutral-800 h-screen w-full '>
